...
namespace PMS.API.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(PMSDbContext pmsDContext)
        {
            this._pmsDbContext = pmsDContext;
        }
        [HttpGet]
        ...
        public async Task<IActionResult> UpdateProduct([FromRoute] Guid id, Product updateProductRequest)
        {
            ...
            product.Titulo = updateProductRequest.Titulo;
            product.Data = updateProductRequest.Data;
            product.Hora = updateProductRequest.Hora;
